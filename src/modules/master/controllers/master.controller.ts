...
//   // ✅ CHANGED: Category aur frequency body se lo
//   async addItem(req: Request, res: Response) {
//     try {
//       const doctorId = (req as any).doctor.id;
//       const { type } = req.params;
//       const { name, category = 'other', frequency = '' } = req.body; // ✅ Category aur frequency lo
      
//       const item = await masterService.addItem(type, name, doctorId, category, frequency);
